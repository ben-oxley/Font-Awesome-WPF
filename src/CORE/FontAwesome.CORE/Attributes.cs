...
namespace FontAwesome.Core
{
        ...
        : Attribute
    {
        ...
        /// <summary>
        /// Initializes a new instance of the FontAwesome.Core.IconCategoryAttribute class.
        /// </summary>
        ...
        : Attribute
    {
        ...
        /// <summary>
        /// Initializes a new instance of the FontAwesome.Core.IconIdAttribute class.
        /// </summary>
